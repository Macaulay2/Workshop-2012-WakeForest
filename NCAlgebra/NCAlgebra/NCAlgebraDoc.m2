...
doc ///
   ...
   Headline
      Divide Bergman output by lead coefficient
   Usage
      Igb = gbFromOutputFile(A,fileName, MakeMonic => true)
   Inputs
      A : NCPolynomialRing
      fileName : String
      MakeMonic : Boolean
...
doc ///
   ...
   Headline
      Return the NCIdeal generated by Bergman output rather than the NCGroebnerBasis
   Usage
      Igb = gbFromOutputFile(A,fileName, ReturnIdeal => false)
   Inputs
      A : NCPolynomialRing
      fileName : String
      ReturnIdeal : Boolean
