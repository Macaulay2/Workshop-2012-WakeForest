...
export { NCRing, NCQuotientRing, NCPolynomialRing,
         generatorSymbols, -- can I get away with not exporting these somehow?
         NCRingElement,
...
-- This is the old remainderFunction.  It was rewritten to handle large GBs more efficiently.
{*
