...
protect symbol squarefree -- needs to be written?
protect symbol lowerP -- needs to be written?
...
myFactorization RingElement := (F) -> (
     ...
     t := local t; -- added MES, for 1.4.0.1
     a := local a; -- added MES, for 1.4.0.1
...
factorGF = (F) -> (
     ...
     R := ring F; -- added MES for 1.4.0.1, is this the correct ring?
