...
document {
  ...
  Headline => "Generate the next and previous partitions",
  SYNOPSIS {
...
document {
  ...
  SYNOPSIS {
    Heading => "Generate the next and previous permutations",
...
document {
  ...
  Headline => "Generate the next and previous standard tableaux",
  SYNOPSIS {
...
document {
  ...
  SYNOPSIS {
    ...
    PARA {
      ...
      This is intended to mitigate extremely long (or non-terminating) computations.
  ...
  SYNOPSIS {
    ...
    EXAMPLE lines ///
      ...
      collectIterations(nextStandardTableau,new YoungDiagram from {2,2,1}) -- standard tableaux of shape 2,2,1
    ///
  }
}
